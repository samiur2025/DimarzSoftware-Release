...
<div className="stat-item"><div className="stat-value">10M</div><div className="stat-label">Total Leads</div></div>
<div className="stat-item"><div className="stat-value">142</div><div className="stat-label">Countries</div></div>
<div className="stat-item"><div className="stat-value">48</div><div className="stat-label">Industries</div></div>
<div className="stat-item"><div className="stat-value">2.1K</div><div className="stat-label">Niches</div></div>
</div>
</div>
</div>
</aside>
